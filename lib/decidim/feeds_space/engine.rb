    ...
    class Engine < ::Rails::Engine
      routes do
        get "feeds/:feed_id", to: redirect { |params, _request|
          feed = Decidim::FeedsSpace::Feed.find(params[:feed_id])
      ...
      isolate_namespace Decidim::FeedsSpace

      # initializer "decidim_feeds.overrides", after: "decidim.action_controller" do
      #   config.to_prepare do
      #     Decidim::HomepageController.include(Decidim::FeedsSpace::NeedsContentBlocksSnippets)
      #   end
      # end
      ...
      initializer "FeedsSpace.add_cells_view_paths" do
        Cell::ViewModel.view_paths << File.expand_path("#{Decidim::FeedsSpace::Engine.root}/app/cells")
        Cell::ViewModel.view_paths << File.expand_path("#{Decidim::FeedsSpace::Engine.root}/app/views")
      end
